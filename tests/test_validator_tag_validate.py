...
async def test_full():
    ...
    test_tag_groups = [
        ...
        #"long_and_short_tag_test1": ["A", "B", "C", "AB", "BC", "ABC", "DEF", ' A valid tag must be a recognizable English word, proper noun, or descriptive phrase that makes sense as a tag or the technical word exceptions such as TRIOUWEW, TEROIEUORE.', 'polka', "TRIOUWEW", "TEROIEUORE", ],
