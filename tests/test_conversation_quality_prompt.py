...
@pytest.mark.asyncio
async def test_prompt_produces_ConversationQualityMetadata():
    ...
    llml = LlmLib()
    res = await llml.validate_conversation_quality(conversation)
...
@pytest.mark.asyncio
async def test_prompt_is_resilient_to_prompt_injection():
    conversation = Conversation(
        guid = "test-guid",
        lines = [
            (0, 'Hello'),
...
@pytest.mark.asyncio
async def test_prompt_is_resilient_to_bad_formatting():
    conversation = Conversation(
        guid = "test-guid",
...
@pytest.mark.asyncio
async def test_prompt_flags_good_quality():
    conversation = Conversation(
        guid = "test-guid",
...
@pytest.mark.asyncio
async def test_prompt_flags_mid_quality():
    conversation = Conversation(
        guid = "test-guid",
...
@pytest.mark.asyncio
async def test_prompt_flags_bad_quality():
    conversation = Conversation(
        guid = "test-guid",
...
@pytest.mark.asyncio
async def test_prompt_flags_repetition_as_bad_quality():
...
@pytest.mark.asyncio
async def test_prompt_handles_multi_party_conversation():
    conversation = Conversation(
        guid = "test-guid",
...
@pytest.mark.asyncio
async def test_prompt_handles_monogue():
    conversation = Conversation(
        guid = "test-guid",
...
@pytest.mark.asyncio
async def test_prompt_handles_special_characters():
    conversation = Conversation(
        guid = "test-guid",
